...
Button(btn_frame, text="Place Order", command=place_order, bg="green", fg="white",
       width=15, font=("Arial", 10, "bold")).pack(side=LEFT, padx=5)

Button(btn_frame, text="Mark Delivered", command=mark_delivered, bg="blue", fg="white",
       width=15, font=("Arial", 10, "bold")).pack(side=LEFT, padx=5)

# ✅ CLEAR BUTTON ADDED
Button(btn_frame, text="Clear", command=clear_fields, bg="red", fg="white",
       width=15, font=("Arial", 10, "bold")).pack(side=LEFT, padx=5)
